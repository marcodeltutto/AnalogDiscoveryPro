...
def open(device_data, sampling_frequency=20e06, buffer_size=0, offset=0, amplitude_range=5, n_acquisitions=1):
    ...
    if dwf.FDwfAnalogInBuffersSet(device_data.handle, ctypes.c_int(n_acquisitions)) == 0:
        check_error()
